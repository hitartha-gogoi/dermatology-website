  ...
  return (
    <div className="bg-white w-full min-h-screen flex flex-col justify-start items-center">
      ...
      <div className="flex flex-row justify-start items-center w-full space-x-0 sm:space-x-10 py-6">
        <Link href="/"><span className="ml-2 text-sm font-medium text-gray-400 p-2 sm:p-6 hover:text-green-800 hover:scale-105 transition-transform duration-200 ease-in-out sm:ml-40">All Patients</span></Link>
        <Link href="/"><span className="text-sm font-medium text-gray-400 p-2 sm:p-6 hover:text-green-800 hover:scale-125 duration-100 transition-transform ease-in-out">Pending</span></Link>
        <Link href="/"><span className="text-sm font-medium text-gray-400 p-2 sm:p-6 hover:text-green-800 hover:scale-125 duration-100 transition-transform ease-in-out">Completed</span></Link>
      </div>
      ...
      <div className="flex flex-row justify-evenly items-center w-full px-4 mt-8">
        ...
        {/*  */}
        <div className="flex flex-row justify-evenly items-center p-4 bg-gray-100 w-96 sm:w-5/6 rounded-md">
          <span className="text-gray-400 font-semibold banner-text w-48 sm:w-56">Name</span>
          <span className="text-gray-400 hidden sm:block font-semibold banner-text w-48">Age</span>
          ...
          <span className="text-gray-400 font-semibold banner-text uppercase w-44 sm:w-48">status</span>
        </div>
      ...
      <div className="flex flex-col justify-evenly items-center w-full px-4">
        ...
        {/* NAME SECTION */}
          < div className="flex flex-row justify-start flex-wrap items-center py-2 w-56">
          ...
          <span className="text-black  hidden sm:block font-semibold banner-text w-48">18</span>
